namespace :json_load do
  ...
  task stores: :environment do
    kroger_stores_80108 = JSON.parse(File.read('./db/data/stores/kroger_80108.json'), symbolize_names: true)
    kroger_stores_80206 = JSON.parse(File.read('./db/data/stores/kroger_80206.json'), symbolize_names: true)
    target_stores_80108 = JSON.parse(File.read('./db/data/stores/target_80108.json'), symbolize_names: true)
    target_stores_80206 = JSON.parse(File.read('./db/data/stores/target_80206.json'), symbolize_names: true)
